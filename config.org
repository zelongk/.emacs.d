...
emacs --quick --script ~/.emacs.d/gen-env-file.el
#+end_src
...
#+end_src
** No-littering
Move temp files into cache directory
#+begin_src emacs-lisp
...
#+end_src
*** Construct modeline
Most of it was from prot's config
#+begin_src emacs-lisp
...
* Lang
** Org
*** Install org-mode -- org-latex-preview
#+begin_src emacs-lisp
  (leaf org
    :straight `(org
                :fork (:host nil
...
#+end_src
*** Texpresso
LaTeX live preview (incremental)
#+begin_src emacs-lisp
...
#+end_src
** Chezmoi
Manage chezmoi repo everywhere
#+begin_src elisp
